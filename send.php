...
if(!empty($recaptcha)) {
    ...
    if($curlData['success']) {
        ...
        $email = urldecode($email);
         $name = trim($name);
        $email = trim($email);
        if (mail("ilya022003@yandex.ru", "Заявка с сайта",.$name. " Хочет связаться, почта для связи: ".$email,"From: test.yartun@yartuningystu.ru \r\n")){  
...
<head>
  ...
  ================================================== -->
	...
	<link rel="stylesheet" href = "/robertfc.beget.tech/project/smart-cookies/css/smart-cookies.css"/>
...
<body class="home-page">
	<script src="/robertfc.beget.tech/project/smart-cookies/js/smart-cookies.js"></script>
	<div class="wrap-body">
		<header>
			<div class="top-bar">
					...
					<div class="col-1-4 col-footer-3">
						<div class="wrap-col">
							...
							<form action="send.php" method="post">
							    <input type="text" name="name" value="" size="40" placeholder="Ваше имя" />
								<input type="text" name="email" value="" size="40" placeholder="Ваш email" />
									<div class="g-recaptcha" data-sitekey="6LeHqismAAAAAAP8_HNlhlo5BeFFzNsmFXZ2BvJr"></div>
